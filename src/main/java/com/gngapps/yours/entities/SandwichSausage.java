...
public class SandwichSausage {
	...
	private List<SandwichSausageAmountAndPrice> sausageAmountAndPrices;
	...
	public List<SandwichSausageAmountAndPrice> getSausageAmountAndPrices() {
		return sausageAmountAndPrices;
	}

	public void setSausageAmountAndPrices(
			List<SandwichSausageAmountAndPrice> sausageAmountAndPrices) {
