...
<body>
	<div class="container">
		...
		<div class="row marketing">
			<div class="col-md-3">
				<h4>
					<a href=""><span style="margin-left: 15px"><spring:message code="yours.list.heading.sandwich" text="Sandwich" /></span></a>
				</h4>
				<!-- Single button -->
				<div class="btn-group">
				...
				<div>
				<c:if test="${!empty sandwichBreads}" >
					<table class="table table-bordered">
						<c:forEach items="${sandwichBreads }" var="sandwichBread" >
							<tr>
								<td>${sandwichBread.nameGeo }</td>
								<td>${sandwichBread.nameEng }</td>
								<td>${sandwichBread.nameRus }</td>
								<td>${sandwichBread.descriptionGeo }</td>
								<td>${sandwichBread.descriptionEng }</td>
								<td>${sandwichBread.descriptionRus }</td>
							</tr>
						</c:forEach>
					</table>
				</c:if>
			...
			<div class="col-md-3">
				...
				<div class="salad-ingredients-list"></div>
			</div>
			<div class="col-md-3">
				<h4>
			...
			<div class="col-md-3">
				...
				<div class="hotdog-ingredients-list"></div>
			</div>
		</div>
	</div>
