	...
	<form action="#" name="formSubmit">
		<table class="table table-bordered">
			<tr>
				...
				<td><input type="text" class="form-control" id="sausageNameGeo" placeholder="${sausageTypeGeo }" /></td>
			</tr>
			<tr>
				<spring:message code="yours.food.service.admin.add.food.components.sausage.type.eng" var="sausageTypeEng"></spring:message>
				<td><input type="text" class="form-control" id="sausageNameEng" placeholder="${sausageTypeEng }" /></td>
			</tr>
			<tr>
				<spring:message code="yours.food.service.admin.add.food.components.sausage.type.rus" var="sausageTypeRus"></spring:message>
				<td><input type="text" class="form-control" id="sausageNameRus" placeholder="${sausageTypeRus }" /></td>
			</tr>
			<tr>
			...
			<tr>
				<td><button type="button" id="hotdog-sausage-add-btn" class="btn btn-default"><spring:message code="yours.food.service.add.button.title"></spring:message></button></td>
			</tr>
		</table>
	</form>
</div>
...
<script>
	$('#hotdog-sausage-add-btn').click(function() {
		...
		data.append('nameGeo', toUnicode($('#sausageNameGeo').val()));
		data.append('nameEng', toUnicode($('#sausageNameEng').val()));
		data.append('nameRus', toUnicode($('#sausageNameRus').val()));
